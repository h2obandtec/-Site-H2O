...
<body>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox type="number" Max="6" CssClass="form-control" ID="boxID" runat="server" placeholder="Ex: Número com 6 digitos" />
                                </div>

                                <div class="form-group">
                                    <label for="boxNome">NOME</label>
                                    <asp:TextBox type="email" CssClass="form-control" ID="boxNome" runat="server" placeholder="Ex: João da Silva" />
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox
                                        type="email"
                                        Enabled="false" CssClass="form-control" ID="boxEmail" runat="server" placeholder="Ex: usuario@h2o.com" />
                                </div>
    ...
    <script id="erro" type="text/javascript" hidden="hidden">
        var c = <%=erroRetorno %>;
        if (c != ""){
            alert(c);
        }
